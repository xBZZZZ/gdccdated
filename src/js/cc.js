...
function save_modal(buffers,name,blobopts){
	set_loading(false);
	var g=div_with_html('<a class="btn thiccb">save <strong></strong></a><input class="thiccb" type="button" value="back"/>'),a=g.firstChild,b=a.href=URL.createObjectURL(new Blob(buffers,blobopts));
