...
arr=[	'objects',
			...
			['2','x',xyf],
			['3','y',xyf],
			['6','rotate','<ul><li>= 0 if doesn&apos;t exist</li><li>unit is degrees</li><li><strong class="when">(2.2) </strong>ignored if rotate x (131) &#8800; rotate y (132)<ul>'+fwarn+'</ul></li></ul>'+img(0,344,400,278)],
