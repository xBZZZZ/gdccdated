...
arr=[	'objects',
			...
			['32','scale','<ul class="linside"><li>= 1 if doesn&apos;t exist</li><li>= 0 is same as not existing (scale = 0 object impossible)</li><li>ignored if scale x (128) or scale y (129) exist<strong class="when"> (2.2)</strong></li></ul>'],
		...
		'start pos and level start',
			...
			['kA24','start with centered camera (2.2)','0','no','1','yes'],
			...
			['85','easing rate',img(0,730,400,90)]
